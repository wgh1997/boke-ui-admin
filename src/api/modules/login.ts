...
export const loginApi = (params: Login.ReqLoginForm) => {
	return http.post<Login.ResLogin>(`users/login`, params); // 正常 post json 请求  ==>  application/json
...
export const getLogout = () => {
	return http.get<Login.ResLogin>(`users/logout`);
};
// * 获取个人信息
export const getUserSinfo = () => {
	return http.get<Login.ResAuthButtons>(`users/info`);
};
// * 获取按钮权限
